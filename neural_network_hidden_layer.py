...
class NeuralNetwork:
    ...
    def predict(self, x: np.ndarray) -> float:
        ...
        input_activation = sigmoid(sum(np.multiply(x,self.input_weights)))
        
        layer.activation_output = sigmoid(sum(np.multiply(input_activation, self.output_weights)))

       
        output_activation = sigmoid(sum(np.multiply(input_activation,self.output_weights)))
